module github.com/urodstvo/messenger-server/apps/auth
...
require (
	...
	github.com/urodstvo/messenger-server/libs/grpc v0.0.0-20240615185211-1d4f742def62
	...
	github.com/urodstvo/messenger-server/libs/models v0.0.0-20240615185211-1d4f742def62
